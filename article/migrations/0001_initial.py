# Generated by Django 2.1.2 on 2019-06-17 14:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_by', models.DateField(blank=True, verbose_name='発注日')),
                ('accept_date', models.DateField(blank=True, verbose_name='受注日')),
                ('status', models.IntegerField(choices=[(1, '執筆中'), (2, '入稿済み'), (3, '公開済み')], default=1, verbose_name='状態')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='作成日')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
                ...
                ('order_at', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_user', to=settings.AUTH_USER_MODEL, verbose_name='発注先')),
            ],
            options={
                'verbose_name': 'オーダー',
